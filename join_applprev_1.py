...
train_static = pl.concat(
    [
        pl.read_csv("csv_files/train/train_applprev_1_0.csv"),
        pl.read_csv("csv_files/train/train_applprev_1_1.csv")
    ],
    how="vertical_relaxed",
)
train_static = train_static.filter(pl.col('num_group1') == 0)
train_static = train_static.drop('num_group1')
train_static = train_static.with_columns(pl.col('status_219L').map_elements(replace_values).cast(pl.Float64))
